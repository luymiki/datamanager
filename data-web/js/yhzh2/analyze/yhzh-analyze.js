...
(function (e, t, $) {
    ...
    var reg = (function () {
                ...
                success : function (msg) {
                    if(msg.status===200){
                        ...
                        myChart.on('click', function (params) {
                            ...
                            //console.log(name);
                            //console.log(data);
                            top.contabs.addMenuItem("/view/yhzh2/analyze/yhzh-range-list.html?id="+yhzhInfo["id"]+"&range="+name+"&zcType="+(zcType||""),'查看交易金额['+name+']流水信息');
                        });
                    }
                },
                error:function(){
        ...
        var _initJyjePieChart = function(){
            var data = [];
            $.ajax.proxy({
                url:"/api/admin/fx/yhzh/jyjeZc100",
                type:"post",
                dataType:"json",
                ...
                success : function (msg) {
                    if(msg.status===200){
                        ...
                        myChart.on('click', function (params) {
                            ...
                            top.contabs.addMenuItem("/view/yhzh2/analyze/yhzh-analyze.html?id="+yhzhInfo["id"]+"&zcType="+type,'查看['+name+']的流水信息');
                        });
                    }
                },
                error:function(){
        ...
        var _event = function () {
            $("#jyds-table").on('click',".jyds",function () {
                ...
                top.contabs.addMenuItem("/view/yhzh2/analyze/yhzh-jyds.html?id="+yhzhInfo["id"]+"&ds_id="+dsid+"&zcType="+(zcType||""),'查看对手['+dsid+']流水信息');
            });
            $("#jyds-table").on('click',".jybs",function () {
                var dsid = $(this).attr("data-dsid");
                top.contabs.addMenuItem("/view/yhzh2/analyze/yhzh-range-list.html?id="+yhzhInfo["id"]+"&ds_id="+dsid+"&zcType="+(zcType||""),'查看['+dsid+']交易流水信息');
            });
