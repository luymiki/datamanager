                ...
                success : function (d) {
                    ...
                    if(d.status===200){
                        ...
                        if(file && file.length===1){
                            yhzhInfo =file[0];
                            title = "银行账号 [ "+yhzhInfo["kh"]+" ] "+(ds_id?"与对手["+ds_id+"]":"")+" 的交易汇总";
                            $("#cft-title").html(title);
                        }
                    }else {
    ...
    var reg = (function () {
                ...
                success : function (msg) {
                    if(msg.status===200){
                        ...
                        myChart.on('click', function (params) {
                            ...
                            console.log(name);
                            console.log(data);
                            top.contabs.addMenuItem("/view/yhzh2/analyze/yhzh-range-list.html?id="+yhzhInfo["id"]+"&range="+name+"&ds_id="+ds_id+"&zcType="+(zcType||""),'查看交易金额['+name+']流水信息');
                        });
        ...
        var _initJyjePieChart = function(){
            ...
            $.ajax.proxy({
                ...
                type:"post",
                dataType:"json",
                data:{"ssyh":yhzhInfo["ssyh"],"kh":yhzhInfo["kh"],"zh":yhzhInfo["zh"],"dsId":ds_id},
                success : function (msg) {
                    if(msg.status===200){
                        jefbid =  msg.data.id;
                        ...
                        myChart.on('click', function (params) {
                            ...
                            top.contabs.addMenuItem("/view/yhzh2/analyze/yhzh-range-list.html?id="+yhzhInfo["id"]+"&ds_id="+ds_id+"&zcType="+type,'查看交易金额['+name+']流水信息');
                        });
                    }
                },
                error:function(){
