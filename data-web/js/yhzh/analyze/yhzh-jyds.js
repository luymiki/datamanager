                ...
                success : function (msg) {
                    if(msg.status===200){
                        ...
                        myChart.on('click', function (params) {
                            ...
                            console.log(name);
                            console.log(data);
                            top.contabs.addMenuItem("/view/yhzh/analyze/yhzh-range-list.html?id="+yhzhInfo["id"]+"&range="+name+"&ds_id="+ds_id+"&zcType="+(zcType||""),'查看交易金额['+name+']流水信息');
                        });
                ...
                success : function (msg) {
                    if(msg.status===200){
                        ...
                        myChart.on('click', function (params) {
                            ...
                            top.contabs.addMenuItem("/view/yhzh/analyze/yhzh-range-list.html?id="+yhzhInfo["id"]+"&ds_id="+ds_id+"&zcType="+type,'查看交易金额['+name+']流水信息');
                        });
                    }
                },
                error:function(){
