...
!function (t) {
    ...
    function l(e, r, i) {
        if (null != e) {
            ...
            if (r == T.String)return t.Globalize.format(e, i)
        }
        return e
    }
    ...
    function h(e, n) {
        if (n)for (var r in n)if ("_" != r[0]) {
            ...
            var i = n[r];
            e._copy && e._copy(r, i) || (e[r] instanceof t.Event ? s(i) && e[r].addHandler(i) : !c(i) || i instanceof Element || !e[r] || "itemsSource" == r ? e[r] = i : h(e[r], i))
        }
    }
    ...
    function v(t, e) {
        if (t && e && t.setAttribute)for (var n = e.split(" "), r = 0; r < n.length; r++) {
            var i = n[r];
            if (_(t, i)) {
                var o = new RegExp("((\\s|^)" + i + "(\\s|$))", "g"), s = t.getAttribute("class");
    ...
    function E(e) {
        for (var n = [], r = e.querySelectorAll("input,select,textarea,button,a,div"), i = 0; i < r.length; i++) {
            var o = r[i];
            if (o.offsetHeight > 0 && o.tabIndex > -1 && !o.disabled && !x(o, "[disabled],.wj-state-disabled")) {
                ...
                if (t.isIE() && !o.hasAttribute("tabindex")) {
                    ...
                    var s = t.Control.getControl(x(o, ".wj-flexgrid"));
    ...
    !function (t) {
    ...
    }(T = t.DataType || (t.DataType = {})), t.tryCast = e, t.isPrimitive = function (t) {
        ...
        if (t.touches && t.touches.length > 0 && (t = t.touches[0]), r(t.clientX) && r(t.clientY))return new P(t.clientX + pageXOffset, t.clientY + pageYOffset);
        throw"Mouse or touch event expected."
    }, t.getType = function (t) {
        return r(t) ? T.Number : o(t) ? T.Boolean : a(t) ? T.Date : n(t) ? T.String : u(t) ? T.Array : T.Object
    ...
    var M = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "/": "&#x2F;"};
    t.hasClass = _, t.removeClass = v, t.addClass = y, t.toggleClass = b, t.setAttribute = C, t.setSelectionRange = function (e, n, r) {
        if (void 0 === r && (r = n), p(e instanceof HTMLInputElement || e instanceof HTMLTextAreaElement, "INPUT or TEXTAREA element expected"), A(document.body, e) && !e.disabled && "none" != e.style.display)try {
        ...
        return n.innerHTML = t, 1 == n.children.length && (n = n.children[0]), e && e.appendChild(n), n
    }, t.setText = function (t, e) {
        t.textContent = e || ""
    }, t.contains = A, t.closest = x, t.closestClass = function (t, e) {
        return x(t, "." + e)
        ...
        return new I(e.left + pageXOffset, e.top + pageYOffset, e.width, e.height)
        ...
        var i = Date.now(), o = setInterval(function () {
            var t = Math.min(1, (Date.now() - i) / n);
            t = Math.sin(t * Math.PI / 2), t *= t, requestAnimationFrame(function () {
                e(t)
            }), t >= 1 && clearInterval(o)
        }, r);
        return o
    ...
    var I = function () {
        ...
        return Object.defineProperty(t.prototype, "right", {
            ...
            if (e instanceof P)return e.x >= this.left && e.x <= this.right && e.y >= this.top && e.y <= this.bottom;
            if (e instanceof t) {
                var n = e;
...
!function (t) {
    ...
    var e = function () {
        ...
        return e.format = function (n, r, i, o) {
            ...
            var r = t.culture.Globalize.numberFormat, i = r["-"] || "-", o = r["%"] || "%",
                s = e.indexOf(i) > -1 || e.indexOf("(") > -1 && e.indexOf(")") > -1 ? -1 : 1,
                a = e.indexOf(o) > -1 ? .01 : 1, u = n ? n.match(/,+/) : null, c = u ? 3 * u[0].length : 0, l = 0;
            if (!n || "x" != n[0] && "X" != n[0]) {
                var h = r["."] || ".", p = new RegExp("[^\\d\\" + h + "]", "g");
                e = e.replace(p, "").replace(h, "."), l = parseFloat(e)
            } else e = e.replace(/[^0-9a-f]+.*$/gi, ""), l = parseInt(e, 16);
            return l * s * a * Math.pow(10, c)
        }, e.parseDate = function (n, r) {
            if (!(n = t.asString(n)))return null;
            if ("u" == r)return new Date(n);
            var i;
            if ("R" == r || "r" == r) {
                var o = /(([0-9]+)\-([0-9]+)\-([0-9]+))?\s?(([0-9]+):([0-9]+)(:([0-9]+))?)?/, s = n.match(o);
                return s[1] || s[5] ? (i = s[1] ? new Date(parseInt(s[2]), parseInt(s[3]) - 1, parseInt(s[4])) : new Date, s[5] && (i.setHours(parseInt(s[6])), i.setMinutes(parseInt(s[7])), i.setSeconds(s[8] ? parseInt(s[9]) : 0))) : i = new Date(n), isNaN(i.getTime()) ? null : i
            }
            r = e._expandFormat(r || "d");
            var a, u, c, l, h, p, f = t.culture.Globalize.calendar, d = e._CJK,
            ...
            for (var O = 0; O < _.length && m; O++) {
                var T = O - v, M = T > -1 && T < m.length ? m[T] : "", P = _[O].length;
                switch (_[O]) {
                    case"EEEE":
                    case"EEE":
                    case"EE":
                    ...
                    case"yy":
                    case"y":
                        P > 1 && M.length > P && (m[T] = M.substr(P), M = M.substr(0, P), v++), y = parseInt(M), h = 4 == M.length;
                        break;
                    case"MMMM":
                    case"MMM":
                        l = !0;
                        var F = M.toLowerCase();
                        b = -1;
                        for (var I = 0; I < 12; I++)if (0 == f.months[I].toLowerCase().indexOf(F)) {
                            b = I;
                            break
                        }
                        if (b > -1)break;
                    case"MM":
                    case"M":
                        l = !0, P > 1 && M.length > P && (m[T] = M.substr(P), M = M.substr(0, P), v++), b = parseInt(M) - 1;
                        break;
                    case"dddd":
                    case"ddd":
                        a = !0;
                    ...
                    case"dd":
                    case"d":
                        P > 1 && M.length > P && (m[T] = M.substr(P), M = M.substr(0, P), v++), C = parseInt(M), u = !0;
                        break;
                    case"hh":
                    case"h":
                        P > 1 && M.length > P && (m[T] = M.substr(P), M = M.substr(0, P), v++), w = 12 == (w = parseInt(M)) ? 0 : w;
                        break;
                    case"HH":
                        P > 1 && M.length > P && (m[T] = M.substr(P), M = M.substr(0, P), v++), w = parseInt(M);
                        break;
                    case"H":
                        w = parseInt(M);
                        break;
                    case"mm":
                    case"m":
                        P > 1 && M.length > P && (m[T] = M.substr(P), M = M.substr(0, P), v++), E = parseInt(M);
                        break;
                    case"ss":
                    case"s":
                        P > 1 && M.length > P && (m[T] = M.substr(P), M = M.substr(0, P), v++), A = parseInt(M);
                        break;
                    case"fffffff":
                    case"FFFFFFF":
                    case"ffffff":
                    ...
                    case"f":
                    case"F":
                        x = parseInt(M) / Math.pow(10, P - 3);
                        break;
                    case"tt":
                    case"t":
                        M = M.toUpperCase(), w < 12 && f.pm.indexOf(M) > -1 && (w += 12);
                        break;
                    case"q":
                    case"Q":
                    case"u":
                    ...
                    case"gg":
                    case"g":
                        S = f.eras.length > 1 ? e._getEra(M, f) : -1;
                        break;
                    case f["/"]:
                    case f[":"]:
                        if (M && M != _[O])return null;
                        break;
                    case"K":
                        break;
                    default:
                        e._unquote(_[O]).trim() != M.trim() && v++
                }
            }
            if (l && u && (isNaN(w) && (w = 0), isNaN(E) && (E = 0), isNaN(A) && (A = 0)), b < 0 || b > 11 || isNaN(b) || C < 1 || C > 31 || isNaN(C) || w < 0 || w > 24 || isNaN(w) || E < 0 || E > 60 || isNaN(E) || A < 0 || A > 60 || isNaN(A))return null;
            if (p) {
                if (!l)return null;
            ...
            return a && !u ? null : c && !l ? null : (y < 0 && (y = (new Date).getFullYear()), S > -1 ? y = y + f.eras[S].start.getFullYear() - 1 : y < 100 && !h && (y += y + 2e3 < (t.isNumber(f.twoDigitYearMax) ? f.twoDigitYearMax : 2029) ? 2e3 : 1900), C > new Date(y, b + 1, 0).getDate() ? null : (i = t.DateTime.newDate(y, b, C, w, E + 0, A, x), isNaN(i.getTime()) ? null : i))
            ...
            switch (i) {
                ...
                case"zz":
                case"z":
                    var f = -n.getTimezoneOffset(), d = void 0;
                    switch (i) {
                        case"zzz":
...
!function (t) {
    ...
    var e = function () {
        function e(n, r, i) {
            ...
            var o = this;
            this._pristine = !0, this._focus = !1, this._updating = 0, this._fullUpdate = !1, this.gotFocus = new t.Event, this.lostFocus = new t.Event, this.refreshing = new t.Event, this.refreshed = new t.Event, this._updateWme(), t.assert(null == e.getControl(n), "Element is already hosting a control.");
            var s = t.getElement(n);
            if (t.assert(null != s, "Cannot find the host element."), this._orgOuter = s.outerHTML, this._orgTag = s.tagName, this._orgAtts = s.attributes, "INPUT" != s.tagName && "SELECT" != s.tagName || (s = this._replaceWithDiv(s)), this._e = s, s[e._CTRL_KEY] = this, 1 == i) {
                this._szCtl = new t.Size(s.offsetWidth, s.offsetHeight);
                var a = this._handleResize.bind(this);
                this.addEventListener(window, "resize", a)
            }
            var u;
            this.addEventListener(s, "focus", function (t) {
                u && clearTimeout(u), u = setTimeout(function () {
                    u = null, o._updateFocusState()
                }, e._FOCUS_INTERVAL)
            }, !0), this.addEventListener(s, "blur", function (t) {
                u && clearTimeout(u), u = setTimeout(function () {
                    u = null, o._updateFocusState()
                }, e._FOCUS_INTERVAL)
            }, !0);
            var c = this._handleDisabled.bind(this);
            if (this.addEventListener(s, "mousedown", c, !0), this.addEventListener(s, "mouseup", c, !0), this.addEventListener(s, "click", c, !0), this.addEventListener(s, "dblclick", c, !0), this.addEventListener(s, "keydown", c, !0), this.addEventListener(s, "wheel", c, t.getEventOptions(!0, !0)), null == e._touching && (e._touching = !1, "ontouchstart" in window || "onpointerdown" in window)) {
                var l = document.body, h = this._handleTouchStart, p = this._handleTouchEnd,
                    f = t.getEventOptions(!0, !0);
                "ontouchstart" in window ? (l.addEventListener("touchstart", h, f), l.addEventListener("touchend", p, f), l.addEventListener("touchcancel", p, f), l.addEventListener("touchleave", p, f)) : "onpointerdown" in window && (l.addEventListener("pointerdown", h, f), l.addEventListener("pointerup", p, f), l.addEventListener("pointerout", p, f), l.addEventListener("pointercancel", p, f), l.addEventListener("pointerleave", p, f))
            }
        }
        ...
        return e.prototype.getTemplate = function () {
            ...
            return null
        }, e.prototype.applyTemplate = function (n, r, i, o) {
            ...
            var p = a.querySelectorAll("input"), f = 1 == p.length ? p[0] : null;
            if (f && (this._copyAttributes(f, a.attributes, e._rxInputAtts), this._copyAttributes(f, this._orgAtts, e._rxInputAtts)), f && a.id) {
                for (var d = a; d.parentElement;)d = d.parentElement;
                var g = d.querySelector('label[for="' + a.id + '"]');
                if (g instanceof HTMLLabelElement) {
                    var m = t.getUniqueId(a.id + "_input");
                    f.id = m, g.htmlFor = m
                }
            }
            if (f) {
                var _ = document.createEvent("HTMLEvents"), v = f.value;
                _.initEvent("change", !0, !1), this.addEventListener(f, "input", function () {
                    s._pristine = !1, v = f.value
                }, !0), this.gotFocus.addHandler(function () {
                    v = f.value
                }), this.lostFocus.addHandler(function () {
                    s._pristine && (s._pristine = !1, s._updateState()), v != f.value && f.dispatchEvent(_)
                })
            }
            if (f ? a.tabIndex = -1 : a.getAttribute("tabindex") || (a.tabIndex = 0), this._updateState(), i)for (var y in i) {
                var b = i[y];
                if (this[y] = u.querySelector('[wj-part="' + b + '"]'), null == this[y] && u.getAttribute("wj-part") == b && (this[y] = u), null == this[y])throw'Missing template part: "' + b + '"';
                if (b == o) {
                    var C = "name", w = a.attributes[C];
                    w && w.value && this[y].setAttribute(C, w.value), C = "accesskey", (w = a.attributes[C]) && w.value && (this[y].setAttribute(C, w.value), a.removeAttribute(C))
                }
            }
            return u
        }, e.prototype.dispose = function () {
            for (var n = this._e.querySelectorAll(".wj-control"), r = 0; r < n.length; r++) {
                var i = e.getControl(n[r]);
                i && i.dispose()
            }
        ...
        }, e.getControl = function (n) {
            var r = t.getElement(n);
            return r ? t.asType(r[e._CTRL_KEY], e, !0) : null
            ...
            var n = this._e, r = t.getActiveElement();
            if (!n)return !1;
            for (var i = r; i;) {
                if (i == n)return !0;
                i = i[e._OWNR_KEY] || i.parentElement
            }
            return !1
            ...
            if (t || (t = document.body), t.children)for (var n = 0; n < t.children.length; n++)e.invalidateAll(t.children[n]);
            var r = e.getControl(t);
            r && r.invalidate()
        }, e.refreshAll = function (t) {
            if (t || (t = document.body), t.children)for (var n = 0; n < t.children.length; n++)e.refreshAll(t.children[n]);
            var r = e.getControl(t);
            r && r.refresh()
        }, e.disposeAll = function (t) {
            var n = e.getControl(t);
            if (n) n.dispose(); else if (t.children)for (var r = 0; r < t.children.length; r++)e.disposeAll(t.children[r])
            ...
            var i = 0;
            if (this._listeners)for (var o = 0; o < this._listeners.length; o++) {
            ...
            var n = window.wijmo._updateWme;
            t.isFunction(n) && n(this, e._licKey)
            ...
            setTimeout(function () {
                for (var n = t.EventArgs.empty, r = document.body.querySelectorAll(".wj-state-focused"), i = 0; i < r.length; i++)(a = e.getControl(r[i])) && a._focus && !a.containsFocus() && (a._focus = !1, a._updateState(), a.onLostFocus(n));
                var o = t.getActiveElement();
                if (o)for (var s = o; s;) {
                    var a = e.getControl(s);
                    a && !a._focus && a.containsFocus() && (a._focus = !0, a._updateState(), a.onGotFocus(n)), s = s[e._OWNR_KEY] || s.parentElement
                }
            })
    ...
    !function (e) {
        ...
        var o = function (n) {
            ...
            return __extends(r, n), r.prototype.push = function () {
                ...
                var o;
                return r && i ? (o = n.prototype.splice.call(this, t, r, i), 1 == r ? this._raiseCollectionChanged(e.NotifyCollectionChangedAction.Change, i, t) : this._raiseCollectionChanged(), o) : i ? (o = n.prototype.splice.call(this, t, 0, i), this._raiseCollectionChanged(e.NotifyCollectionChangedAction.Add, i, t), o) : (o = n.prototype.splice.call(this, t, r), 1 == r ? this._raiseCollectionChanged(e.NotifyCollectionChangedAction.Remove, o[0], t) : this._raiseCollectionChanged(), o)
                ...
                0 !== this.length && (this.splice(0, this.length), this._raiseCollectionChanged())
        ...
        var n = function () {
            function n(n, r) {
                ...
                this._idx = -1, this._srtDsc = new e.ObservableArray, this._grpDesc = new e.ObservableArray, this._newItem = null, this._edtItem = null, this._pgSz = 0, this._pgIdx = 0, this._updating = 0, this._stableSort = !1, this._canFilter = !0, this._canGroup = !0, this._canSort = !0, this._canAddNew = !0, this._canCancelEdit = !0, this._canRemove = !0, this._canChangePage = !0, this._trackChanges = !1, this._chgAdded = new e.ObservableArray, this._chgRemoved = new e.ObservableArray, this._chgEdited = new e.ObservableArray, this.collectionChanged = new t.Event, this.sourceCollectionChanging = new t.Event, this.sourceCollectionChanged = new t.Event, this.currentChanged = new t.Event, this.currentChanging = new t.Event, this.pageChanged = new t.Event, this.pageChanging = new t.Event, this._srtDsc.collectionChanged.addHandler(function () {
                    for (var n = i._srtDsc, r = 0; r < n.length; r++)t.assert(n[r] instanceof e.SortDescription, "sortDescriptions array must contain SortDescription objects.");
                    i.canSort && i.refresh()
                }), this._grpDesc.collectionChanged.addHandler(function () {
                    for (var n = i._grpDesc, r = 0; r < n.length; r++)t.assert(n[r] instanceof e.GroupDescription, "groupDescriptions array must contain GroupDescription objects.");
                    i.canGroup && i.refresh()
            ...
            return n.prototype._copy = function (n, r) {
                ...
                var t = this._srtDsc, e = this._srtCvt, n = this._srtCmp, r = !0, i = 0;
                return function (o, s) {
                    for (var a = 0; a < t.length; a++) {
                        var u = t[a], c = u._bnd.getValue(o), l = u._bnd.getValue(s);
                        if (e && (c = e(u, o, c, r), l = e(u, s, l, !1), r = !1), n && null != (i = n(c, l)))return u.ascending ? +i : -i;
                        if (c !== c && (c = null), l !== l && (l = null), "string" == typeof c && "string" == typeof l) {
                            var h = c.toLowerCase(), p = l.toLowerCase();
                            h != p && (c = h, l = p)
                        }
                        if (null != c && null == l)return -1;
                        if (null == c && null != l)return 1;
                        if (0 != (i = c < l ? -1 : c > l ? 1 : 0))return u.ascending ? +i : -i
                    }
                    return 0
                }
                ...
                if (null != t) {
                    this._committing = !0;
                    var n = this._sameContent(t, this._edtClone), r = this._pendingRefresh;
                    this._edtItem = null, this._edtClone = null;
                    var i = this._pgView.indexOf(t), o = this._digest;
                    this._performRefresh(), n || this._trackItemChanged(t), this._pgView.indexOf(t) != i || o != this._digest || r ? this._raiseCollectionChanged() : this._raiseCollectionChanged(e.NotifyCollectionChangedAction.Change, t, i), this._committing = !1
                }
                ...
                if (arguments.length > 0 && t.assert(!1, "addNew does not take any parameters, it creates the new items."), this.commitEdit(), this.commitNew(), !this.canAddNew)return t.assert(!1, "cannot add items (canAddNew == false)."), null;
        ...
        return e.prototype.setTooltip = function (e, n) {
            ...
            if (!e.defaultPrevented)if ("click" != e.type || t.Control._touching) {
                ...
                this._clearTimeouts(), this._toShow = setTimeout(function () {
                    ...
                    if (r > -1) {
                        var i = n._tips[r], o = n._showAtMouse ? new t.Rect(e.clientX, e.clientY, 0, 0) : null;
...
!function (t) {
    ...
    function n(e) {
        ...
        return r && t.isFunction(r.dialog) && null != r.dialog("instance")
    }
    ...
    t.showPopup = function (r, i, o, s, a) {
        ...
        if (i instanceof HTMLElement) {
            ...
            for (var c = i; c; c = c.parentElement)if (n(c) || "fixed" == getComputedStyle(c).position) {
                u = c;
                break
            }
        }
        ...
        if (t.setCss(r, {
                ...
                left: 0,
                top: 0
            }), r.offsetHeight && r.offsetWidth && t.contains(u, r) || u.lastChild != r && u.appendChild(r), i instanceof HTMLElement && a) {
            var m = getComputedStyle(i);
            new t.Color(m.backgroundColor).a && t.setCss(r, {
                color: m.color,
        ...
        t.setCss(r, {position: "fixed", display: ""}), t.Control.refreshAll(r);
        var _ = getComputedStyle(r), v = parseFloat(_.marginTop) + parseFloat(_.marginBottom),
            y = parseFloat(_.marginLeft) + parseFloat(_.marginRight),
            b = new t.Size(r.offsetWidth + y, r.offsetHeight + v), C = new t.Point, w = null, E = p.clientWidth,
            A = p.clientHeight;
        ...
        if (w) {
            var S = w.top, O = A - w.bottom, T = "rtl" == getComputedStyle(r).direction;
            C.x = T ? Math.max(0, w.right - b.width) : Math.max(0, Math.min(w.left, E - b.width)), C.y = o ? S > b.height || S > O ? Math.max(0, w.top - b.height) : w.bottom : O > b.height || O > S ? w.bottom : Math.max(0, w.top - b.height), x = Math.max(x, w.width), t.isIE() && (x -= r.offsetWidth - (r.clientWidth + parseInt(_.borderLeftWidth) + parseInt(_.borderRightWidth)))
        } else C.y + b.height > A - 20 && (C.y = Math.max(0, A - 20 - b.height)), C.x + b.width > E - 20 && (C.x = Math.max(0, E - 20 - b.width));
        var M = {position: "absolute", left: C.x + h.x, top: C.y + h.y, minWidth: x, zIndex: 1500}, P = null;
        s && (r.style.opacity = "0", P = t.animate(function (t) {
            r.style.opacity = t < 1 ? t.toString() : ""
        })), i instanceof HTMLElement && (r[t.Control._OWNR_KEY] = i), t.setCss(r, M);
        var F = i instanceof MouseEvent ? i.target : i;
        if (F instanceof HTMLElement && F.parentElement != document.body) {
            var I = Date.now(), D = F.getBoundingClientRect(), j = new t.Control(document.createElement("div"));
            r[t.Control._SCRL_KEY] = j, j.addEventListener(document, "scroll", function (n) {
                if (Date.now() - I > 100 && t.contains(document, F) && !t.contains(r, n.target) && (n.target != document || null != i && "fixed" == r.style.position)) {
                    var o = F.getBoundingClientRect(), s = Math.abs(o.left - D.left), a = Math.abs(o.top - D.top);
                    (s > 1 || a > 1) && e(r, !0)
                }
            }, !0)
        }
...
wijmo.culture.Licensing = window.wijmo.culture.Licensing || {
        ...
        ctc: 'Please <a target="_blank" href="https://www.grapecity.com/en/licensing/wijmo">create a license</a> or contact GrapeCity: <a href="mailto:us.sales@grapecity.com">us.sales@grapecity.com</a>.',
        hdr: "Wijmo License",
        cls: "CLOSE"
    };
var wijmo;
!function (t) {
    ...
    function r(e, n, r) {
        var c = t.culture.Licensing || M, h = null;
    ...
    function p(e, r, i) {
        (!r || r.trim().length < 15) && (r = (t.culture.Licensing || M).evl), (!r || r.trim().length < 15) && (r = atob("V2lqbW8gRXZhbHVhdGlvbiBWZXJzaW9uICh7dmVyc2lvbn0p"));
        var o = null;
        if (i && i.Exp) {
            var s = i.Exp;
    ...
    function f(t, e, n, r) {
        ...
        if (!i)return r();
        var o = i.licData, s = i.prefix + "#" + e.algorithmCode;
        ...
        var c = {name: "RSASSA-PKCS1-v1_5", hash: {name: "SHA-256"}},
            l = {alg: "RS256", e: "AQAB", kty: "RSA", n: x(e.publicKey)};
    ...
    function d(t, e) {
        try {
            e = "#" + e;
            var n = t.indexOf(e);
            if (n > -1)return {prefix: t.substring(0, n), licData: JSON.parse(g(t.substr(n + e.length)))}
        } catch (t) {
        }
        return null
    }
    ...
    var F = window.Uint8Array || TypedArray
}(wijmo || (wijmo = {}));
var wijmo;
!function (t) {
    "use strict";
    var e = function () {
        ...
        return Object.defineProperty(e.prototype, "input", {
            ...
            this._composing = !0
        }, e.prototype._compositionend = function (t) {
            var e = this;
            ...
            return e
        }, e.prototype._handleVagueLiterals = function (t) {
            if (t.length > this._mskArr.length + 1)return t;
            var e = t.length - this._mskArr.length;
            if (0 != e && t.length > 1) {
                for (var n = -1, r = Math.max(0, this._tbx.selectionStart - e); r < this._mskArr.length; r++)if (this._mskArr[r].vague) {
                    n = r;
                    break
                }
                if (n > -1)if (e < 0) {
                    var i = Array(1 - e).join(this._promptChar), o = n + e;
...
!function (t) {
    ...
    document.addEventListener("test", function (t) {
        ...
        return u ? {capture: t, passive: e} : t
    };
    var c = !1;
    ...
    }, document.doctype && navigator.appVersion.indexOf("MSIE 9") > -1 && (a = !0, document.addEventListener("mousemove", function (e) {
        if (1 == e.which) {
            var n = t.closest(e.target, ".wj-control");
            if (n && !n.style.cursor)for (var r = e.target; r; r = r.parentNode)if (r.attributes && r.attributes.draggable)return r.dragDrop(), !1
        }
    }));
    ...
    if (!window[l]) {
        var h = 0;
        window[l] = function (t) {
            var e = Date.now(), n = 16 - (e - h), r = n > 0 ? n : 0;
    ...
    if (!window.atob) {
        var p = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", f = new RegExp("[^" + p + "]");
