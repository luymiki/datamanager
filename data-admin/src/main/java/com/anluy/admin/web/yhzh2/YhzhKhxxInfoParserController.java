...
import com.anluy.admin.web.yhzh2.parser2.YhzhJylsParser2;
import com.anluy.admin.web.yhzh2.parser2.YhzhKhxxParser2;
...
public class YhzhKhxxInfoParserController {
    ...
    public Object save(HttpServletRequest request, @RequestBody  Attachment attachment) {
        try {
            ...
            YhzhKhxxParser2 parser = new YhzhKhxxParser2(attachment);
            YhzhJylsParser2 parserJyls = new YhzhJylsParser2(attachment);
