 ...
 */
@RestController
@RequestMapping("/api/admin/zfb/logininfo")
@Api(value = "/api/admin/zfb/logininfo", description = "支付宝登录日志文件操作")
public class ZfbLoginInfoParserController {
    private static final Logger LOGGER = LoggerFactory.getLogger(ZfbLoginInfoParserController.class);
    @Resource
     ...
     * @return
     */
    @ApiOperation(value = "支付宝登录日志文件保存", response = Result.class)
    ...
    public Object save(HttpServletRequest request, @RequestBody  Attachment attachment) {
        try {
            ...
            elasticsearchRestClient.batchSave(saveList,"zfblogininfo");
     ...
     * @return
     */
//    @ApiOperation(value = "支付宝登录日志文件删除", response = Result.class)
