 ...
 */
public class YhzhJylsParser2 {
    private static final Logger LOGGER = LoggerFactory.getLogger(YhzhJylsParser2.class);
    private final Attachment attachment;

    public YhzhJylsParser2(Attachment attachment) {
    ...
    public static void main(String[] args) {
        YhzhJylsParser2 zfbRegParser = new YhzhJylsParser2(new Attachment());
        try {
